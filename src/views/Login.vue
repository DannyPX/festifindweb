<template>
  <div id="outer">
    ...
    <button class="btn btn-primary facebookbtn" @click="logInWithFacebook">
      Ga door met Facebook
    </button>
    <br />
    <button class="btn btn-light normalbtn" v-on:click="normalLogin">
      Login
    </button>
    <br />
    <button class="btn btn-light normalbtn" v-on:click="normalRegister">
      Registreer
    </button>
  </div>
</template>
