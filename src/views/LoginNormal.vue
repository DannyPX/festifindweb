  ...
  <div id="content">
    ...
    <form class="form">
      <div class="form-group">
        ...
        <input type="password" class="form-control input" id="exampleInputEmail1" :value="credentials.email" @input="updateEmail">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Wachtwoord</label>
        <input type="password" class="form-control input" id="exampleInputPassword1" :value="credentials.password" @input="updatePassword">
      </div>
